...
const defaultVisitData = {
  doctor: { name: 'Vivek Menon', specialty: 'Endocrinologist', initial: 'V', color: '#5B5FC6', rating: 4.8 },
...
export default function PostVisitSummary() {
  ...
  const visitData = fromState || (isDemo
    ? defaultVisitData
    : {
      doctor: { name: '', specialty: '', initial: profile?.initials || '', color: '#5B5FC6', rating: null },
      date: '',
      type: '',
      time: '',
  ...
  const rx = prescription || (isDemo ? defaultPrescription : null)
  ...
  return (
    <div className="postvisit-page" ref={pageRef}>
      <div className="postvisit-header">
        <button className="postvisit-back-btn" onClick={() => navigate(-1)}>
        ...
        <button className="postvisit-share-btn">
          Share
      ...
      <div className="postvisit-content">
        <div className="postvisit-success-banner">
          ...
          <div className="postvisit-success-text">
            ...
            <div className="postvisit-success-subtitle">Your care plan has been updated.</div>
          </div>
        </div>
          ...
          <div className="postvisit-doctor-top">
            <div className="postvisit-doctor-left">
              ...
              <div className="postvisit-doctor-info">
                <div className="postvisit-doctor-name">Dr. {doctor.name}</div>
        ...
        <div className="postvisit-card">
          ...
          <button className="postvisit-inline-action">
        ...
        <div className="postvisit-card">
          ...
          <button className="postvisit-primary-btn">Book Follow-Up</button>
          <button className="postvisit-calendar-link">
        ...
        <button className="postvisit-download-btn">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="postvisit-support-card">
          ...
          <div className="postvisit-support-list">
            <button className="postvisit-support-row">
            ...
            <button className="postvisit-support-row postvisit-support-row-last">
