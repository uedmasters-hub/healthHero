...
function visitAtMinutesFromNow(minutes) {
  ...
  return {
    ...
    dateLabel: start.toLocaleDateString('en-IN', { weekday: 'short', day: 'numeric', month: 'short', year: 'numeric' }),
...
export function visitSummary(visit) {
  return {
    ...
    date: visit.start.toLocaleDateString('en-IN', { weekday: 'long', day: 'numeric', month: 'short', year: 'numeric' }),
